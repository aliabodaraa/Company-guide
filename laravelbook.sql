...
--
-- Host: 127.0.0.1
-- Generation Time: 27 مايو 2021 الساعة 17:39
...
CREATE TABLE `authors` (
  ...
  `image` text COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'https://i.pinimg.com/736x/8b/16/7a/8b167af653c2399dd93b952a48740620.jpg',
...
CREATE TABLE `books` (
  ...
  `link_name` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `book_user` (
  ...
  `review` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'nothing',
...
(11, '2021_04_04_155734_create_categories_table', 1),
(12, '2021_04_04_155801_create_authors_table', 1),
(13, '2021_04_14_142954_create_books_table', 1),
(14, '2021_04_19_103717_create_book_user_table', 1);
...
CREATE TABLE `users` (
  ...
  `utype` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USR' COMMENT 'USR for normal users and ADM for Admin ',
  `image` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
ALTER TABLE `books`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `books_link_name_unique` (`link_name`) USING HASH,
